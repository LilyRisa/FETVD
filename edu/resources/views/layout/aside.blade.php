    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                {{-- <li><a href=""><i class="fas fa-key"></i>Nhóm nhân viên</a>
                </li>

                <li><a href=""><i class="fas fa-sync-alt"></i>Sync</a>
                </li>
                <li> <a href=""><i class="ti-settings"></i>cấu hình hệ thống
                    </a>
                </li> --}}
                ...
                {{-- <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                    ...
                    <ul aria-expanded="false" class="collapse">
                    <li><a href="{{route('employee_raw')}}">Thống kê dữ liệu nhân viên</a></li>
                        {{-- <li><a href="#">Raw visitor(s)</a></li>
                        <li><a href="#">Thermal Reports</a></li> --}}
                    </ul>
                </li> --}}
                ...
                <li>
                    <a class="waves-effect waves-dark" href="../documentation/documentation.html"
                        aria-expanded="false">
