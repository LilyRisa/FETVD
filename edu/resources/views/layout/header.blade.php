            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <a class="navbar-brand" href="{{route('home')}}">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                        <img src="{{'images/hiface_logo.png'}}" alt="homepage" class="dark-logo" style="width: 90%; margin-bottom: -10px;">
                            <!-- Light Logo icon -->
                            <img src="{{'images/hiface_logo.png'}}" alt="homepage" class="light-logo" style="width: 90%; margin-bottom: -10px">
                        </b>
                        <!--End Logo icon -->
                        {{-- <!-- Logo text --><span>
                            <!-- dark Logo text -->
                ...
                <div class="navbar-collapse">
                    ...
                    <div class="nav-item" style="margin-right: 30px">
                        <button class="btn btn-warning" id="sync_st"><i class=" fas fa-undo-alt"></i> Sync</button>
                    </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown">
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center ps ps--theme_default" data-ps-id="1b224b01-5291-2a2e-f06d-bcb54dc5e748">
                                            <!-- Message -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mailbox dropdown-menu-right animated bounceInDown" aria-labelledby="2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center ps ps--theme_default" data-ps-id="44e69342-cade-0abb-dab9-0b33a8f8d485">
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                ...
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="{{'images/big/img2.jpg'}}" alt="Second slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
