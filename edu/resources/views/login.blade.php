...
<head>
	...
	color:#edf3ff;
	background:#c8c8c8;
	background:url({{asset('images/backg.jpg')}}) fixed;
...
.login-wrap{
	...
	min-height:510px;
	position:relative;
	background:url({{asset('images/back_chill.jpg')}}) no-repeat center;
	background-size: cover;
...
<body>
	<?php echo \Session::get('ACCESS_TOKEN'); ?>
        ...
        <div class="login-html">
            ...
            <div class="login-form">
                <div class="sign-in-htm">
                    ...
                    <div class="group">
                        <input type="submit" class="button" value="Đăng nhập" id="login">
                    </div>
                    <div class="hr"></div>
                </div>
